...
const aboutFaqs = [
  {
    question: 'How long does it take to implement OMEDO in our hospital?',
    answer:
  ...
  {
    question: 'How does OMEDO ensure patient data security and privacy?',
    answer:
      'We employ robust AES-256 bit encryption for data at rest, secure TLS protocols in transit, granular role-based access control (RBAC), automated backups, and comprehensive audit logs.',
  },
  {
    question: 'Can OMEDO integrate with our existing lab machines and pharmacy POS?',
    answer:
      'Absolutely. OMEDO supports REST APIs and HL7/FHIR healthcare standards for seamless integration with laboratory equipment, RIS/PACS imaging, pharmacy POS hardware, and Tally accounting.',
  },
  {
  ...
  {
    question: 'Does OMEDO support multi-branch hospital chains and centralized reporting?',
    answer:
      'Yes. OMEDO offers centralized cloud administration allowing hospital groups to manage multiple branches, consolidate financial analytics, share doctor schedules, and track inventory across locations seamlessly.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes! OMEDO includes a responsive web portal and mobile-friendly interface for doctors to review IPD rounds, approve lab reports, and check patient vitals anytime, anywhere.',
  },
]
...
export default function About() {
  ...
  return (
    <motion.div {...pageTransition}>
        ...
        <div className="site-wrapper grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 2xl:gap-16 items-center">
          ...
          <motion.div className="space-y-5 sm:space-y-6 text-center lg:text-left"
            ...
            <motion.div
              ...
              <span className="font-medium text-xs sm:text-sm">Enterprise Hospital Management &amp; Healthcare Innovation</span>
            </motion.div>
            ...
            <motion.p className="text-description text-[#3d4947] max-w-xl mx-auto lg:mx-0" variants={fadeUp}>
              At OMEDO, we believe that medical professionals shouldn't be bogged down by
      ...
      {/* ── Healthcare Technology & Clinical Innovation Section ── */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 2xl:gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border shadow-xs"
                ...
                <span className="font-bold text-xs sm:text-sm tracking-wide">Ghaziabad, India • Hospital Tech Pioneers</span>
              </div>

              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#121d1f] leading-[1.15] tracking-tight"
                style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Engineering Hospital Management Software with{' '}
                <span style={{
              ...
              <p className="text-sm sm:text-base text-[#3d4947] leading-relaxed"
                style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                From multi-specialty hospitals to advanced diagnostic labs and clinical networks, we build hospital management software engineered for clinical resilience, operational efficiency, and scalable patient care.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full pt-2">
                <div className="bg-white/90 backdrop-blur-md p-3.5 rounded-2xl border border-[#bcc9c6]/40 shadow-xs text-left">
                  <div className="text-2xl font-black text-[#00685e]">ABDM</div>
                  <div className="text-[11px] font-semibold text-[#6d7a77] uppercase tracking-wider">Enabled Suite</div>
                </div>
                <div className="bg-white/90 backdrop-blur-md p-3.5 rounded-2xl border border-[#bcc9c6]/40 shadow-xs text-left">
                  <div className="text-2xl font-black text-[#00685e]">Multi</div>
                  <div className="text-[11px] font-semibold text-[#6d7a77] uppercase tracking-wider">Branch Ready</div>
                </div>
                <div className="bg-white/90 backdrop-blur-md p-3.5 rounded-2xl border border-[#bcc9c6]/40 shadow-xs text-left">
            ...
            >
              ...
              >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-base sm:text-lg font-bold text-[#121d1f]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      Empowering Adaptable Healthcare Workflows
                    </h3>
                    <p className="text-sm sm:text-base text-[#3d4947] leading-relaxed text-justify" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      We engineer specialized <strong className="text-[#00685e] font-bold">Hospital Management Software</strong> to make clinical care and administrative operations seamless, efficient, and adaptable. Based out of Ghaziabad (NCR), India, our dedicated team of healthcare technology experts and medical informatics engineers empowers hospitals, multi-specialty centers, and diagnostic clinics across India.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-base sm:text-lg font-bold text-[#121d1f]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      Unified Clinical &amp; Cloud Dynamism
                    </h3>
                    <p className="text-sm sm:text-base text-[#3d4947] leading-relaxed text-justify" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      Our solutions encompass fully integrated <strong className="text-[#121d1f] font-semibold">OPD, IPD, EMR, Laboratory Diagnostics, Pharmacy POS, and Cashless Billing</strong> tailored for single and multi-branch medical facilities. Dynamism and innovation are at our core, delivering cloud-native, mobile-ready, and ABDM-enabled digital infrastructure for modern healthcare providers.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <motion.div
              ...
              <div>
                ...
                <p className="opacity-90 text-sm sm:text-base" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  Data privacy and security is our top priority. We protect sensitive medical and clinical records with multi-layered encryption.
                </p>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 2xl:gap-24 items-center">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {[
                ...
                { icon: 'shield_lock', label: 'Encrypted & Secure' },
        ...
        <div className="site-wrapper">
          <motion.div
            ...
            <p className="text-description text-[#3d4947] max-w-2xl mx-auto mb-8 sm:mb-10">
              Join thousands of medical facilities that trust OMEDO to handle their operations,
