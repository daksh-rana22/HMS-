export const faqs = [
  ...
  },
  {
    ...
    answer:
      'We offer tiered support: email support for Starter plans, priority support with faster response times for Professional plans, and 24/7 dedicated phone support with a personal account manager for Enterprise plans. All plans include access to our knowledge base and community forum.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'All plans include comprehensive documentation and video tutorials. Professional plans add live webinar training sessions. Enterprise clients receive on-site training programs customized for each department, plus ongoing refresher sessions and a dedicated success manager.',
  },
]
